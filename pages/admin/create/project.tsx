...
const AdminCreateNotice: NextPage<StaticProps> = ({ CatagoryList }) => {
...
export const getStaticProps: GetStaticProps = async () => {
  const CatagoryList: ProjectCatagoryDTO[] = await fetch(process.env.NEXT_PUBLIC_API_URL + "/api/catagory")
    .then((res) => res.json())
    .then((data) => {
      return data;
    });
